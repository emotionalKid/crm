...
<script type="text/javascript">
	...
	$(function(){
		...
		// var company   =$("#queryCompanyId").val()
		// var pageNo=1;
		// var pageSize=10;
		// $.ajax({
		// 	url: "workbench/clue/selectClueByConditionAndAccount.do",
		// 	data: {
		// 		name:name,
		// 		owner:owner    ,
		// 		phone:phone    ,
	...
	function selectCondition(pageNo,pageSize){
		...
		$.ajax({
			...
			success:function (data){
				...
				$("#selAll").prop("checked",false)
					var totalPages=1
					if(data.account%pageSize==0){
						totalPages=data.account/pageSize
					}else {
						totalPages=parseInt(data.account/pageSize)+1;
					}
					// alert(totalPages)
				...
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" id="queryCompanyId" type="text">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    <div class="input-group">
				      ...
				      <input class="form-control" id="queryMphone" type="text">
				    </div>
				  </div>
